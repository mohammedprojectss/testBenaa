...
<!-- one Div -->
<div class="choose ba">
    <h1 class="subText">تخصص الهندسة</h1>
    <p class="bold">أفضل المعلمين و المحاضرين لتخصص الهندسة</p>
    <div>
<style>
  #axo{
    width: 320px;
...
<form action="thistr.php" name='f' method='post'>
  ...
  هندسة مدنية <br> 
    <p class="bold"></p><i class="fa-solid fa-2x fa-building"></i>
  </button>
  <input type="hidden" value='three' name='part'>
  <input type="hidden" value='hm' name='lang'>
    </form>
    <form action="thistr.php" name='f' method='post'>
  <button class='area subText undefined' id='axo' style='cursor: pointer;' type='submit' name='s' >
  هندسة عمارة <br> 
  ...
  <input type="hidden" value='three' name='part'>
  <input type="hidden" value='hk' name='lang'>
    </form>
    <form action="thistr.php" name='f' method='post'>
  <button class='area subText undefined' id='axo' style='cursor: pointer;' type='submit' name='s' >
  هندسة كهرباء <br> 
    <p class="bold"></p><i class="fa-solid fa-2x fa-lightbulb"></i>
  </button>
  <input type="hidden" value='three' name='part'>
  <input type="hidden" value='hme' name='lang'>
    </form>
    <form action="thistr.php" name='f' method='post'>
  <button class='area subText undefined' id='axo' style='cursor: pointer;' type='submit' name='s' >
  هندسة ميكانيكا <br> 
  ...
  <input type="hidden" value='three' name='part'>
  <input type="hidden" value='hmekanika' name='lang'>
    </form>
    <form action="thistr.php" name='f' method='post'>
  <button class='area subText undefined' id='axo' style='cursor: pointer;' type='submit' name='s' >
  علوم الحاسب <br> 
    <p class="bold"></p><i class="fa-solid fa-2x fa-display"></i>
  </button>
  <input type="hidden" value='three' name='part'>
  <input type="hidden" value='hh' name='lang'>
    </form>
    <form action="thistr.php" name='f' method='post'>
  <button class='area subText undefined' id='axo' style='cursor: pointer;' type='submit' name='s' >
  ميكاترونيكس  <br> 
  ...
  <input type="hidden" value='three' name='part'>
  <input type="hidden" value='hmek' name='lang'>
    </form>
    <form action="thistr.php" name='f' method='post'>
  <button class='area subText undefined' id='axo' style='cursor: pointer;' type='submit' name='s' >
  هندسة طاقة <br> 
    <p class="bold"></p><i class="fa-solid fa-2x fa-volcano"></i>
  </button>
  <input type="hidden" value='three' name='part'>
  <input type="hidden" value='ht' name='lang'>
    </form>
    <form action="thistr.php" name='f' method='post'>
  <button class='area subText undefined' id='axo' style='cursor: pointer;' type='submit' name='s' >
  هندسة ميكانيكا السيارات <br> 
    <p class="bold"></p><i class="fa-solid fa-2x fa-car"></i>
  </button>
  <input type="hidden" value='three' name='part'>
  <input type="hidden" value='hmcar' name='lang'>
    </form>
    <form action="thistr.php" name='f' method='post'>
  <button class='area subText undefined' id='axo' style='cursor: pointer;' type='submit' name='s' >
  هندسة طبية <br> 
    <p class="bold"></p><i class="fa-solid fa-2x fa-cross"></i>
  </button>
  <input type="hidden" value='three' name='part'>
  <input type="hidden" value='ht' name='lang'>
    </form>
...
<div class="choose ba">
    <h1 class="subText">تخصص الطب البشري</h1>
    <p class="bold">أفضل المعلمين و المحاضرين لتخصص الطب البشري</p>
    <div>
<style>
  #axo{
    width: 320px;
...
<form action="thistr.php" name='f' method='post'>
  <button class='area subText undefined' id='axo' style='cursor: pointer;' type='submit' name='s' >
  طب بشري <br> 
    <p class="bold"></p><i class="fa-solid fa-2x fa-people-group"></i>
  </button>
  <input type="hidden" value='three' name='part'>
  <input type="hidden" value='tb' name='lang'>
    </form>
  ...
  <button class='area subText undefined' id='axo' style='cursor: pointer;' type='submit' name='s' >
  صيدلة <br> 
    <p class="bold"></p><i class="fa-solid fa-2x fa-rod-snake"></i>
  </button>
  <input type="hidden" value='three' name='part'>
  <input type="hidden" value='si' name='lang'>
    </form>
  ...
  <button class='area subText undefined' id='axo' style='cursor: pointer;' type='submit' name='s' >
  علاج طبيعي <br> 
    <p class="bold"></p><i class="fa-solid fa-2x fa-tree"></i>
  </button>
  <input type="hidden" value='three' name='part'>
  <input type="hidden" value='et' name='lang'>
    </form>
...
<div class="choose ba">
    <h1 class="subText">تخصص العلوم الأساسية</h1>
    <p class="bold">أفضل المعلمين و المحاضرين لتخصص العلوم الأساسية </p>
    <div>
<style>
  #axo{
    width: 320px;
