...
<title>عنا</title>
        ...
        <div class='header' style="height:70vh;">
          ...
          <div class="header-img">
            <img src="asimg/pic1.png" class='imggg' alt="img" />
          </div>
      </div>


        <div class='our-projects'>
          <h1 class='subText'>من أعمالنا الهندسية</h1>
          <img src="asimg/work1.jpg" alt="" />
          <img src="asimg/work2.jpg" alt="" />
          <img src="asimg/work3.jpg" alt="" />
          <img src="asimg/work4.jpg" alt="" />
          <img src="asimg/work5.jpg" alt="" />
        </div>


        <div class='managers'>
          <div class='mngr'>
            <h2 class='subText'>مهندس أحمد عبد اللطيف</h2>
            <p class='bold'>المدير المسؤول و صاحب المنصة<br/>مهندس كهرباء electrical and electronic engineer <br/>خبرة بالعمل الطلابي و المشاريع الهندسية و أعمال الإنشاءات لأكثر من 6 سنين</p>
            <a target='_blank' href="https://wa.me/qr/H66ZAHWFXFL2G1">تواصل معه</a>
          </div>
          <div class='mngr'>
            <h2 class='subText'>مهندسة آية عبد الرحيم</h2>
            <p class='bold'>المدير المسؤول شريك في المنصة<br/>مهندسة ميكانيكا mechanical engineer <br/>خبرة منذ 2012 في العمل الطلابي و المشاريع الهندسية و الإدارة و التخطيط</p>
