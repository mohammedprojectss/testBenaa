...
<title>فيديوهات الكورس</title>
    ...
    <!-- <h1 class="subText">كورس الأستاذ فلان في مادة الرياضيات</h1> -->
    <div class="videos">
        <div class="video">
...
$ti = $_POST['ti'] ;
echo  "
<video src='$url' height='650' controls ></video>
" ; 
$p = mysqli_query($conn,"select * from $ti");
echo "
<div class='theList' style='margin-top:20px;'>
...
while($row  =mysqli_fetch_array($p)){
    ...
    <i class='fa-solid fa-photo-video fa-2x'></i>
     ...
     <input type='hidden' value='$na' name='na' readonly >  
        ...
        <input type='text' readonly name='syb' value='$ds'
        style='
...
font-size: 19px;
        '
        >
        <input type='submit' name='sb' value='الإنتقال للدرس' style='cursor:pointer;'>
     </form>
   </div>
    ";
}
